(function () {
  ...
  // Scroll fix: keep fast native browser scrolling for wheel, scrollbar drag, PageUp/PageDown,
  // Contact page, Quote page and all long pages.
  // No custom wheel animation is used, so dragging the browser scrollbar will not jump back.
